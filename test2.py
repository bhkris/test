...
# creating collection (data to be stored in the table)
#one record
data = {
    "name" : "bhar",
...
# creating database and tables and stories docs inside it
database = client["myinfo"]
collection = database["bhar_coll"]  #stories data inside the collection
collection.insert_one(data)  #inserting the data into collection
collection.insert_many(list_of_records)

collection1 = database["bhar_coll2"]
